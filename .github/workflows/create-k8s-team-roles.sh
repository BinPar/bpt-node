...
for team in $teams; do
  ...
  kubectl create clusterrolebinding $team-read-ns --group="$repoOwner:$team" --clusterrole=cluster-read-namespace --save-config --dry-run=client -o yaml | kubectl apply -f -
done
